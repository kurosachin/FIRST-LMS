...
$sql = "SELECT id, firstname, lastname, username, grade_level, program FROM students WHERE 1=1";
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar.shrink { width: 70px; }
    .sidebar h2 { text-align: center; margin-bottom: 1rem; font-size: 1.2rem; }
    .sidebar.shrink h2 span { display: none; }
    .sidebar ul { list-style: none; padding: 0 1rem; }
    .sidebar li { padding: 0.8rem; transition: background-color 0.2s; }
    ...
    .sidebar.shrink .section-title, .sidebar.shrink li span { display: none; }
    .sidebar li a {
    ...
    .content.shrink { margin-left: auto; }
    .manage-table {
      background: #fff;
    ...
    .add-btn:hover { background-color: #34495e; }
    .action-link {
      color: #2980b9;
      text-decoration: none;
      margin-right: 10px;
...
<div class="content" id="content">
  <button class="print-btn" onclick="printContent('students-content', 'Students Management Report')">
    ...
    <div class="manage-table">
      ...
      <form method="GET" class="filter-form" style="margin-bottom: 20px; display: flex; gap: 10px; align-items: center;">
        ...
        <?php if (!empty($program_filter) || !empty($grade_filter)): ?>
          <a href="manage_students.php" style="padding: 5px 15px; background-color: #e74c3c; color: white; border: none; border-radius: 4px; text-decoration: none;">
